...
public class DSStep8Activity extends DSActivity {
	private TextView mAnswerText;
	private TextView mAnswerText2;
	private EditText mBox11;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAnswerText2 = (TextView) findViewById(R.id.TextView_Box10);
        mBox11 = (EditText) findViewById(R.id.Box11);
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
            	saveState();
            	Intent i = new Intent(DSStep8Activity.this, DSStep9Activity.class);
    ...
    private void populateFields() {
        if (mRowId != null) {
        	String[] columns = {StatementDbAdpater.KEY_BOX8,StatementDbAdpater.KEY_BOX10,StatementDbAdpater.KEY_BOX11};
            ...
            mBox11.setText(entry.getString(
	...
	private void saveState() {
        String box11 = mBox11.getText().toString();
        
        if (mRowId != null) {
        	ContentValues args = new ContentValues();
            args.put(StatementDbAdpater.KEY_BOX11, box11);
