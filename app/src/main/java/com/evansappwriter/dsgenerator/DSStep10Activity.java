...
public class DSStep10Activity extends DSActivity {
	private TextView mAnswerText;
	private TextView mAnswerText2;
	private TextView mAnswerText3;
	private TextView mAnswerText4;
	private TextView mAnswerText5;
	private EditText mBox15;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAnswerText3 = (TextView) findViewById(R.id.TextView_Box12);
        mAnswerText4 = (TextView) findViewById(R.id.TextView_Box13);
        mAnswerText5 = (TextView) findViewById(R.id.TextView_Box14);
        mBox15 = (EditText) findViewById(R.id.Box15);
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
            	saveState();
            	Intent i = new Intent(DSStep10Activity.this, DSStep11Activity.class);
    ...
    private void populateFields() {
        if (mRowId != null) {
        	String[] columns = {StatementDbAdpater.KEY_BOX8,StatementDbAdpater.KEY_BOX11,StatementDbAdpater.KEY_BOX12,StatementDbAdpater.KEY_BOX13,StatementDbAdpater.KEY_BOX14,StatementDbAdpater.KEY_BOX15};
	...
	private void saveState() {
        String box15 = mBox15.getText().toString();
        
        if (mRowId != null) {
        	ContentValues args = new ContentValues();
            args.put(StatementDbAdpater.KEY_BOX15, box15);
